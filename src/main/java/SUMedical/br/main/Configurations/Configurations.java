...
public class Configurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers(HttpMethod.POST, "/add/{loginID}/magneto").permitAll()
                .requestMatchers(HttpMethod.POST, "/cadastrar").permitAll()
                .requestMatchers(HttpMethod.POST, "/login").permitAll()
                .requestMatchers(HttpMethod.GET, "/buscar/{id}").permitAll()
                .requestMatchers(HttpMethod.GET, "/buscar").permitAll()
                .requestMatchers(HttpMethod.GET, "/lista/magnetos").permitAll()
                .requestMatchers(HttpMethod.GET, "/lista/clientes").permitAll()
